        ...
        <div>
          ...
          <div>
            <input
              type="submit"
              value="Add"
              className="mt-2 cursor-pointer appearance-none border-[#3321c8] text-center text-[#3321c8] block w-full px-3 h-[40px] border rounded-[3px] placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            />
          </div>
        </div>
      </form>
