          ...
          <div className="flex justify-center w-full">
            <div className="relative">
              <img
                ...
                className="w-[150px] h-[150px] rounded-full object-cover border-[3px] border-[#3321c8]"
                alt=""
              />
              ...
              <form aria-required onSubmit={handleSubmit} className="w-full">
                <div className="w-full block p-4">
                  ...
                  <div className="w-full pb-2">
                    <input
                      type="submit"
                      className={`${styles.input} mt-5 cursor-pointer border-[#3321c8] text-center text-[#3321c8]`}
                      required
                      readOnly
                    />
                  </div>
      ...
      <div className="w-full">
        ...
        >
          ...
          <div className="w-[100%] 800px:w-[50%] mt-4">
            ...
            />
            <input
              className={`w-[95%] h-[40px] border border-[#3321c8] text-center text-[#3321c8] rounded-[3px] mt-8 cursor-pointer`}
              required
              value="Update"
              type="submit"
            />
