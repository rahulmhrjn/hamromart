...
const Cart = ({ setOpenCart }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full bg-[#0000004b] h-screen z-10">
      <div className="fixed top-0 right-0 h-full w-[50%] 800px:w-[25%] overflow-y-scroll bg-white flex flex-col justify-between shadow-sm">
        {cart && cart.length === 0 ? (
          ...
          <>
            ...
            <div className="px-5 mb-3">
              ...
              <Link to="/checkout">
                <div
                  className={`h-[45px] flex items-center justify-center w-[100%] bg-[#3321c8] rounded-[5px]`}
                >
                  <h1 className="text-[#fff] 800px:text-[18px] font-[600]">
...
const CartSingle = ({ data, quantityChangeHandler, removeFromCartHandler }) => {
  ...
  const increment = (data) => {
    if (data.stock < value) {
      toast.error("Product stocks are limited!");
    } else {
      setValue(value + 1);
    ...
    <div className="border-b p-4">
      <div className="w-full flex items-center">
        ...
        <img
          ...
          alt=""
          className="w-[130px] h-min ml-2 mr-2 rounded-[px]"
        />
