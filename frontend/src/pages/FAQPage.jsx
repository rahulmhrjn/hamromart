          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                at support@hamrocart.com with your order number and a brief
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                support@hamrocart.com, or by calling us at 9812345678 between
                the working hours of 9am and 5pm, Monday through Friday.
              </p>
            </div>
          )}
        </div>
